...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryString = "CREATE TABLE " + Contract.TABLE_TODO.TABLE_NAME + " ("+
                ...
                Contract.TABLE_TODO.COLUMN_NAME_CHOICE + " TEXT NOT NULL, " +//Use for the 4 choices for the spinner
                Contract.TABLE_TODO.COLUMN_NAME_STATUS + " TEXT NOT NULL, " +//Use to check if a to do is done
